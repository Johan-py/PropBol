...
export default function FilterBar({
  ...
  const handleSearch = async (e?: React.FormEvent) => {
    ...
    const esTerreno =
      tipoFinal === "TERRENO" || tipoFinal === "TERRENO_MORTUORIO";
      ...
      >
        ...
        {variant === "map" && (
          <div className="flex items-center gap-3 flex-1 overflow-visible pb-1">
            <div className="shrink-0">
              ...
              >
                <DollarSign
                  className={`w-4 h-4 ${isPriceFilterActive ? "text-white" : "text-stone-500"}`}
                />
                <span>Precio</span>
                <ChevronDown
                  className={`w-4 h-4 ${isPriceFilterActive ? "text-white" : "text-stone-400"}`}
                />
              </button>
            </div>
            <div className="shrink-0">
            ...
            <div className="shrink-0">
              ...
              >
                <Maximize
                  className={`w-4 h-4 ${isSuperficieFilterActive ? "text-white" : "text-stone-500"}`}
                />
                <span>Metros</span>
                <ChevronDown
                  className={`w-4 h-4 ${isSuperficieFilterActive ? "text-white" : "text-stone-400"}`}
                />
              </button>
            </div>
            <div className="shrink-0">
        ...
        >
          <button
            ...
            className={`${
              variant === "map"
                ? "h-[36px] px-6 shadow-md"
                : "w-full md:w-auto h-[46px] px-10"
