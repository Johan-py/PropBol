...
export default function PublicacionCard({
  ...
  const [modalCancelPromocionAbierto, setModalCancelPromocionAbierto] =
    useState(false);
  ...
  const handlePromocionar = async (
    ...
    try {
      ...
      await publicacionService.confirmarPublicidad(
        propiedadId,
        paymentIntentId,
        planId,
      );
          ...
          <div className="mb-4 flex items-start justify-between gap-4">
            ...
            <div className="flex flex-col items-center pt-1">
              <button
                ...
                disabled={isToggling}
                aria-label={
                  activa ? "Desactivar publicación" : "Activar publicación"
                }
