...
export default function Navbar() {
  ...
  // Categorías con sus respectivos slugs para el filtro del mapa
  const categoriasMobile = [
    { name: "Casas", slug: "casa" },
    { name: "Departamentos", slug: "departamento" },
    { name: "Cuartos", slug: "cuarto" },
    { name: "Terrenos", slug: "terreno" },
    { name: "Espacios de cementerios", slug: "cementerio" },
  ];
          ...
          >
            ...
            <nav className="mt-10 flex flex-col gap-2">
              ...
              <div id="tour-propiedades-mobile" className="flex flex-col">
                ...
                >
                  {categoriasMobile.map((item) => (
                    <Link
                      key={item.slug}
                      href={`/busqueda_mapa?tipo=${item.slug}`}
                      onClick={() => setIsMobileMenuOpen(false)}
