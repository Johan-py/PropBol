          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between px-1">
                ...
                <span className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.15em] text-[#B45309]">
                  <Eye className="h-3 w-3" />
                  Vista previa en vivo
                </span>
              </div>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-px rounded-[32px] bg-[#F5F5F4] shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-black/5 overflow-hidden">
                {/* Editor Column */}
                ...
                {/* Preview Column */}
                <div className="bg-[#FAFAFA] flex flex-col border-l border-[#F5F5F4]">
                  ...
                  <div className="flex-1 px-8 py-8 overflow-y-auto max-h-[600px] prose prose-stone prose-amber">
                    {contenido ? (
                      <ReactMarkdown
                        ...
                        components={{
                          h1: ({ node, ...props }) => <h1 className="text-3xl font-bold mb-4 text-[#1C1917]" {...props} />,
                          h2: ({ node, ...props }) => <h2 className="text-2xl font-bold mb-3 text-[#1C1917]" {...props} />,
                          h3: ({ node, ...props }) => <h3 className="text-xl font-bold mb-2 text-[#1C1917]" {...props} />,
                          p: ({ node, ...props }) => <p className="text-base leading-relaxed text-[#44403C] mb-4" {...props} />,
                          ul: ({ node, ...props }) => <ul className="list-disc pl-5 mb-4 space-y-2 text-[#44403C]" {...props} />,
                          ol: ({ node, ...props }) => <ol className="list-decimal pl-5 mb-4 space-y-2 text-[#44403C]" {...props} />,
