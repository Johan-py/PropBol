    ...
    <article className="grid gap-4 border-t border-stone-200 px-5 py-5 first:border-t-0 md:grid-cols-[minmax(0,2.6fr)_1.1fr_0.9fr_0.9fr_0.8fr] md:items-center md:px-6">
      <div className="grid items-start gap-4 md:grid-cols-[4rem_minmax(0,1fr)]">
        ...
        <div className="min-w-0 pt-0.5">
          ...
          <h2 className="mt-2 text-xl font-semibold leading-tight text-stone-900">{blog.title}</h2>
        ...
        <section className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-stone-600">
              Revisa, aprueba o rechaza las ultimas publicaciones de la comunidad inmobiliaria. El
              estado queda guardado localmente para esta demo mientras no exista integracion con
              backend.
            </p>
