 ...
 <div className="w-28 h-28 rounded-full bg-white border border-gray-300 relative flex items-center justify-center shadow-sm mb-10">
    ...
    <button
      className="
        ...
        md:right-1/2 md:translate-x-1/2 md:top-full md:mt-6  /* pc → abajo */
...
<div className="w-full md:w-2/3">
  ...
  <div className="flex w-full items-center gap-2">
    <select
      ...
      className={`flex-1 px-3 pr-15 py-2 rounded text-sm
        ${campoEditando === "pais"
          ? "bg-white border border-amber-500"
          : "bg-gray-200 cursor-not-allowed"}
      `}
  ...
  <div className="flex w-full items-center gap-2">
    ...
    >
      <Pencil size={16} />
          ...
          {/* DIRECCIÓN */}
          <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
            <label className="w-full md:w-40">Dirección:</label>
            <div className="flex w-full items-center gap-2">
              <input
              ...
              />
              <button onClick={() => setCampoEditando("direccion")}>
                <Pencil size={16}/>
              </button>
            </div>
          </div>

        </div> {/* SE CIERRA EL CONTENEDOR DE CAMPOS */}
      ...
      <SecurityModal isOpen={isSecurityModalOpen} onClose={() => setIsSecurityModalOpen(false)} onSubmit={() => {}} />
      <OtpModal isOpen={isOtpModalOpen} onClose={() => setIsOtpModalOpen(false)} onSubmit={() => {}} onResendCode={() => {}} />
