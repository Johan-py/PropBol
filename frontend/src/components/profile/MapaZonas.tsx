...
const PROPIEDADES_MOCK: Propiedad[] = [
    { id: 1, titulo: "Casa amplia zona norte", precio: "$85,000", tipo: "Casa", lat: -17.3878, lng: -66.1548, zonaId: 1 },
    { id: 2, titulo: "Departamento moderno", precio: "$45,000", tipo: "Departamento", lat: -17.3908, lng: -66.1582, zonaId: 1 },
    { id: 3, titulo: "Terreno en esquina", precio: "$30,000", tipo: "Terreno", lat: -17.3928, lng: -66.1528, zonaId: 1 },

    { id: 4, titulo: "Casa con jardín", precio: "$95,000", tipo: "Casa", lat: -17.4022, lng: -66.1468, zonaId: 2 },
    { id: 5, titulo: "Departamento 3 dorm.", precio: "$55,000", tipo: "Departamento", lat: -17.4044, lng: -66.1476, zonaId: 2 },
    { id: 6, titulo: "Oficina céntrica", precio: "$40,000", tipo: "Oficina", lat: -17.4031, lng: -66.1456, zonaId: 2 },

    { id: 7, titulo: "Casa familiar", precio: "$75,000", tipo: "Casa", lat: -17.3942, lng: -66.1586, zonaId: 3 },
    { id: 8, titulo: "Terreno plano", precio: "$25,000", tipo: "Terreno", lat: -17.3962, lng: -66.1612, zonaId: 3 },
]
