...
export default function MapaZonas({ zonas = [], zonasConPropiedades = [] }: MapaZonasProps) {
              ...
              <div className="text-sm min-w-[200px]">
                ...
                {tienePropiedadesVisibles ? (
                  ...
                  <p className="text-xs text-stone-400 mt-2">
                    Activa "Mostrar propiedades" en la tarjeta para ver las propiedades dentro de
                    esta zona.
                  </p>
                )}
              </div>
            ...
            <Popup>
              <div className="text-sm min-w-[220px]">
                ...
                <p className="text-xs text-stone-500 mt-0.5">
                  {prop.superficie_m2}m² | {prop.nro_cuartos || '?'} hab | {prop.nro_banos || '?'}{' '}
                  baños
                </p>
                <p className="text-xs text-stone-500 mt-1">
                  {prop.direccion}, {prop.ciudad}
                </p>
                <p className="text-xs text-stone-400 mt-1">Propietario: {prop.propietario}</p>
              </div>
            </Popup>
          </Marker>
        )
