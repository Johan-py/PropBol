      ...
      <section className="mx-auto max-w-4xl">
        ...
        <div className="rounded-3xl border border-stone-200 bg-white p-6 shadow-sm sm:p-10">
          ...
          <div className="mt-8 space-y-4">
            <PreferenceCard
              icon={
                <Mail className="h-9 w-9 text-stone-400 sm:h-10 sm:w-10" />
              }
              title="Recibir notificaciones por correo electrónico"
          ...
          <div className="mt-16 border-t border-stone-200 pt-6">
            {showMessage && (
              <div className="mb-4 rounded-xl border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-700">
                Configuración guardada correctamente en el frontend.
              </div>
            )}
            ...
            <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
              <button
                ...
                className="inline-flex items-center justify-center rounded-2xl border border-stone-300 bg-white px-8 py-3 text-base font-medium text-stone-700 transition hover:bg-stone-50"
              >
                Cancelar
              </button>
