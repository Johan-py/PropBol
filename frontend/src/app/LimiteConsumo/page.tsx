    ...
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-6 gap-4">
        ...
        <Link href="/cobros-suscripciones">
            <button className="group flex items-center gap-3 bg-gradient-to-r from-black to-orange-400 text-white px-10 py-5 text-2xl font-extrabold rounded-lg hover:bg-orange-900 transition">
