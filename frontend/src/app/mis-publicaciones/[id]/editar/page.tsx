...
import { editarPublicacion, obtenerDetallePublicacion } from '@/services/publicacion.service'
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      >
        ...
        <div>
          <label className="mb-2 block text-sm font-semibold text-gray-700">Precio</label>
          <input
            type="number"
            name="precio"
            value={form.precio}
