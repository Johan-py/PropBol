    ...
    <div className="flex min-h-screen items-center justify-center bg-[#f5f5f4] px-4 py-10">
        ...
        {isIncognito && (
            ...
            <p className="text-center text-xs leading-relaxed text-amber-800">
                <span className="font-semibold">Estás en modo incógnito.</span>{' '}
                El enlace del correo funcionará con normalidad, pero tu sesión se cerrará al cerrar el navegador.
            </p>
            </div>
        )}
