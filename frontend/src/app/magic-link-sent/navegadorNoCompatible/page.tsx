...
export default function UnsupportedBrowserPage() {
  ...
  const [incompatibleFeature, setIncompatibleFeature] = useState<string | null>(
    null,
  );
      ...
      <div className="w-full max-w-sm">
        <div className="rounded-xl border border-[#e7e5e4] bg-white px-6 py-8 shadow-sm sm:px-8">
          ...
          <p className="mt-3 text-center text-sm leading-relaxed text-[#78716c]">
            Tu navegador no es compatible con PropBol. Para continuar, por favor
            usa una versión actualizada de alguno de estos navegadores:
          </p>
          ...
          <div className="rounded-lg border border-red-100 bg-red-50 px-4 py-3">
            <p className="text-center text-xs leading-relaxed text-red-700">
              ...
              necesario para el funcionamiento seguro del ingreso con enlace
              mágico.
            </p>
          </div>
        </div>
        ...
        <p className="mt-4 text-center text-xs text-[#a8a29e]">
          Si crees que esto es un error, intenta limpiar el caché de tu
          navegador.
        </p>
      </div>
    </div>
