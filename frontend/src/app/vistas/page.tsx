        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-500 text-xs">
              {MOCK_PROPERTIES.length} propiedades encontradas
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {displayedProperties.map((prop: any) => {
            ...
            return (
              <div
                key={prop.id}
                className="group bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden relative hover:shadow-md transition-all"
              >
