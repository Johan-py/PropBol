  ...
  const verificar = async () => {
    ...
    try {
      ...
      if (res.ok && data.ok) {
        ...
        setResultadoVerif({
          ok: false,
          msg: data.error ?? data.mensaje ?? "Verificación fallida",
        });
      }
    } catch {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 font-sans">
      ...
      <div className="flex items-center gap-2 mb-4 bg-amber-50 border border-amber-200 rounded-lg px-4 py-2 text-sm text-amber-700">
        ...
        Integración operando sobre{" "}
        <strong className="ml-1">Testnet Shasta</strong> (no mainnet).
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="border border-gray-200 rounded-xl p-5 shadow-sm">
            ...
            <p className="text-4xl font-extrabold text-gray-900">
              {pago.totalUsdt.toFixed(6)}{" "}
              <span className="text-2xl text-blue-600">USDT</span>
            </p>
          ...
          <div className="border border-gray-200 rounded-xl p-5 shadow-sm">
            ...
            <p className="text-sm text-amber-600 font-medium mb-3">
              ⚠ Envía exactamente{" "}
              <strong>{pago.totalUsdt.toFixed(6)} USDT</strong> a la dirección
              indicada.
            </p>
        ...
        <div className="space-y-4">
          ...
          <div className="border border-gray-200 rounded-xl p-5 shadow-sm">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span>
                  Bs. {(pago.totalBob - pago.totalBob / 1.13).toFixed(2)}
                </span>
              </div>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  ...
                  <span
                    className={`text-sm ${step.done ? "text-gray-800" : "text-gray-400"}`}
                  >
                    {step.label}
                  </span>
                </div>
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 text-xs text-blue-700 space-y-2">
            <p>
              <strong>QR Estático — Uso único</strong>
              <br />
            ...
            <p>
              ...
              <br />
              Cuando el sistema detecte que el pago se completó, la pantalla se
              actualizará sin que tengas que refrescarla.
            </p>
            {isExpired && (
              <p className="text-red-600 font-medium">
                <strong>Tiempo agotado</strong> — La transacción fue cancelada
                automáticamente. Elige otro método.
              </p>
            )}
          </div>
        </div>
