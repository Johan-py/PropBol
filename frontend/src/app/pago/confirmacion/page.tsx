      ...
      <div className="max-w-lg mx-auto px-6 pt-12">
        <div className="text-center mb-8">
          ...
          <p className="text-stone-500 leading-relaxed">
            Tu suscripción ha sido activada. Hemos enviado el comprobante a tu
            correo electrónico.
          </p>
        </div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-stone-800">
                  {payment.planNombre ?? "Plan contratado"}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-stone-500">Subtotal</span>
                <span className="text-stone-700">
                  Bs. {Number(payment.subtotal ?? 0).toFixed(2)}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-stone-500">IVA (13%)</span>
                <span className="text-stone-700">
                  Bs. {Number(payment.iva_monto ?? 0).toFixed(2)}
                </span>
              </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-green-700 mt-1 leading-relaxed">
                Recibirás un email con el comprobante en PDF adjunto. Revisa tu
                bandeja de entrada o spam si no lo encuentras.
              </p>
            </div>
          </div>
        </div>
