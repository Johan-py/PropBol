    ...
    const check = async () => {
      try {
        const res = await fetch(
          `${API_URL}/api/transacciones/${paymentId}/estado`,
        );
        if (!res.ok) return;
      ...
      <div className="max-w-lg mx-auto px-6 pt-12">
        <div className="text-center mb-8">
          ...
          <p className="text-stone-500 leading-relaxed">
            Recibimos tu solicitud. Un administrador está verificando tu
            transferencia.
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-amber-700 mt-1 leading-relaxed">
                Cuando el administrador confirme tu pago, serás redirigido
                automáticamente a la pantalla de confirmación. No necesitas
                refrescar.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-stone-500 mt-1 leading-relaxed">
                Una vez aprobado el pago, te enviaremos el comprobante en PDF a
