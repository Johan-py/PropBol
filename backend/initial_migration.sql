[dotenv@17.3.1] injecting env (2) from .env -- tip: 🤖 agentic secret storage: https://dotenvx.com/as2
-- CreateSchema
...
-- CreateTable
CREATE TABLE "ubicacion_maestra" (
    "id" SERIAL NOT NULL,
    ...
    CONSTRAINT "ubicacion_maestra_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "ubicacion_maestra_nombre_idx" ON "ubicacion_maestra"("nombre");
...
-- AddForeignKey
ALTER TABLE "ubicacion_inmueble" ADD CONSTRAINT "ubicacion_inmueble_ubicacionMaestraId_fkey" FOREIGN KEY ("ubicacionMaestraId") REFERENCES "ubicacion_maestra"("id") ON DELETE SET NULL ON UPDATE CASCADE;
