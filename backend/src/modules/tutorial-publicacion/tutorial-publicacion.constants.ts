...
export const TUTORIAL_PUBLICACION_CONTENT: TutorialPublicacionContent = {
  ...
  mensaje:
    "Antes de iniciar la publicación, asegúrate de tener preparados los datos generales del inmueble, su ubicación, precio, características principales y el material multimedia necesario.",
  videoUrl: "",
  thumbnailUrl: null,
  subtitlesUrl: null,
