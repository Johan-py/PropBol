...
export const validateCurrentPasswordService = async (userId: number, password: string) => {
...
export const deactivateAccountService = async (userId: number, password: string) => {
