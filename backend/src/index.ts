...
// Rutas de Propiedades e Inmuebles
...
// EXPORTACIÓN PARA VERCEL (Crucial para evitar el 404 en producción)
export default app;

// MANEJO DE SERVIDOR LOCAL
